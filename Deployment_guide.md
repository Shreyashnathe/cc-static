...
Use this if you want the project to open directly from GitHub.

### 1. Push the static site files to GitHub

Make sure the repository contains the site entry file at the root of the publish folder:

- `index.html`
- `styles.css`
- `script.js`

If your files are inside a subfolder such as `CC-Static_website_deployement/`, GitHub Pages will not serve them unless that folder is selected as the publishing source.

### 2. Enable GitHub Pages

1. Open your repository on GitHub.
2. Go to **Settings** > **Pages**.
3. Under **Build and deployment**, choose one of these:

- **Deploy from a branch**: select the branch and folder that contains `index.html`
- **GitHub Actions**: use a workflow to publish the site

4. Save the settings.

### 3. Wait for the live URL

GitHub will generate a Pages URL after the deployment finishes. Open that URL, not the normal repository page.

### 4. Common GitHub Pages issues

1. Site shows repository files instead of the web page

- Cause: Pages is not enabled.
- Fix: turn on Pages in repository settings.

2. Site shows 404

- Cause: `index.html` is not in the published folder.
- Fix: publish the correct branch/folder or move the static files to the selected source.

3. CSS or JS not loading

- Cause: wrong file paths or files not included in the published source.
- Fix: keep the assets beside `index.html` and use relative paths.

---

## Option D: Deploy via AWS Amplify (Git-based, easiest CI/CD)
